...
Explanation
BSTIterator bSTIterato  r = new BSTIterator([7, 3, 15, null, null, 9, 20]);
...
def solution():
    iterator_1 = BSTIterator(TreeNode(7, TreeNode(3), TreeNode(15, TreeNode(9), TreeNode(20))))
    print(iterator_1.next())
    print(iterator_1.next())
    print(iterator_1.hasNext())
    print(iterator_1.next())
    print(iterator_1.hasNext())
    print(iterator_1.next())
    print(iterator_1.hasNext())
